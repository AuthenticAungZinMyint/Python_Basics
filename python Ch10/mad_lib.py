...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        #Create a label and entry text for a verb
        Label(self,
              text = "Verb:"
    ...
    def tell_story(self):
        """ Fill the text box with a new based on user input. """
        ...
        story += person
        story += " had nearly given up long quest to find the lost city of "
        story += noun.title()
