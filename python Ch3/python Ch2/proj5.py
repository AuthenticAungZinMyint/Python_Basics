print('If  a 2000 pound pregnent hippo gives birth to a 100 pound calf,')
print('but then eats 20 pounds of food, how much does she weight?')
input('Press the enter key to find out.')
print('2000 - 100 + 50 =' , 2000 - 100 + 50)
print('\nIf an adventurer returns from a sucessful quest and buys each of')
